// Main server entry point: sets up the Apollo Server with Express and WebSockets.
// Loads schema and resolvers, configures plugins, starts the HTTP and WS servers.
